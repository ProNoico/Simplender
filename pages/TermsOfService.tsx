        ...
        <div className="bg-white dark:bg-neutral-900">
            <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="space-y-6 text-neutral-600 dark:text-neutral-300">
                    <h1 className="text-3xl font-bold text-center text-neutral-900 dark:text-neutral-100">Términos y Condiciones de Uso de Simplender</h1>
                    ...
                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">1. Descripción del Servicio</h2>
                    ...
                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">2. Cuentas de Usuario</h2>
                    ...
                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">3. Uso Aceptable</h2>
                    ...
                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">4. Planes y Pagos</h2>
                    ...
                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">5. Propiedad Intelectual</h2>
                    ...
                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">6. Limitación de Responsabilidad</h2>
                    ...
                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">7. Almacenamiento de Datos</h2>
                    ...
                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">8. Modificaciones</h2>
                    ...
                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">9. Terminación</h2>
                    <p>Podemos suspender o cancelar tu cuenta y el acceso al Servicio si incumples estos Términos.</p>

                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">10. Legislación Aplicable</h2>
                    <p>Estos Términos se regirán e interpretarán de acuerdo con las leyes de [Jurisdicción Legal, ej. la República Argentina].</p>

                    <h2 className="text-2xl font-semibold pt-4 text-neutral-800 dark:text-neutral-200">11. Contacto</h2>
